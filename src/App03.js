...
function App() {
  ...
  //=> [text] : text 값 변화에만 반응
  //=> [count, text] : count, text 값 변화에 모두 반응
  ...
  //     //=> ref 객체는 current 속서으로 접근 (const didMountRef=true 이 아님에 주의)
