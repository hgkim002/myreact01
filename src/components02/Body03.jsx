...
export default function Body() {
  ...
  return (
    <div className="body">
      ...
      <div>
        <input name='name' value={member.name} onChange={memberChange} placeholder='이름을 입력하세요' />
      </div>
      <div>
      ...
      <div>
        <input name='birth' type='date' value={member.birth} onChange={memberChange} />
      </div>
      <div>
        <textarea name='info' value={member.info} onChange={memberChange} />
      </div>
    </div>
